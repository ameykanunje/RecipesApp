...
final class RecipesViewModelTests: XCTestCase {
    ...
    func test_GetImage_FromCache() async throws {
        ...
        vm.imageCache.setObject(mockImage, forKey: url.absoluteString as NSString)
    ...
    func test_ClearImage_FromCache() async throws {
        // Given
        let url = URL(string: "https://example.com/image.jpg")!
        let _ = await vm.getImage(for: url) // This will cache the mock image
        
        // When
        vm.cleanData()
        
        // Then
        let cachedImage = vm.imageCache.object(forKey: url.absoluteString as NSString)
